...
| Metric | Value |
|--------|-------|
| **Tests** | 593 total (551 ✅ passed, 16 ❌ failed, 4 ⏭️ skipped, 22 ⚠️ errors) |
| **Test Files** | 67 files (55 unit, 10 integration, 2 functional) |
| **Code Coverage** | 62% (3,844 / 6,183 executable lines) |
