...
| Metric | Value |
|--------|-------|
| **Tests** | 612 total (568 ✅ passed, 1 ❌ failed, 28 ⏭️ skipped, 15 ⚠️ errors) |
| **Test Files** | 69 files (56 unit, 11 integration, 2 functional) |
| **Code Coverage** | 63% (4,026 / 6,358 executable lines) |
