...
| Metric | Value |
|--------|-------|
| **Tests** | 911 total (825 ✅ passed, 28 ⏭️ skipped, 58 ⚠️ errors) |
| **Test Files** | 98 files (66 unit, 27 integration, 5 functional) |
| **Code Coverage** | 67% (5,127 / 7,683 executable lines) |
| **Source Code** | 92 Python files (19k total LOC) |
