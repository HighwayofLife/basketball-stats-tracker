...
| Metric | Value |
|--------|-------|
| **Tests** | 936 total (885 ✅ passed, 1 ❌ failed, 28 ⏭️ skipped, 22 ⚠️ errors) |
| **Test Files** | 101 files (67 unit, 29 integration, 5 functional) |
| **Code Coverage** | 54% (4,291 / 7,958 executable lines) |
