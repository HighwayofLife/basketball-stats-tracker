...
| Metric | Value |
|--------|-------|
| **Tests** | 883 total (797 ✅ passed, 28 ⏭️ skipped, 58 ⚠️ errors) |
| **Test Files** | 95 files (64 unit, 26 integration, 5 functional) |
| **Code Coverage** | 67% (5,016 / 7,528 executable lines) |
| **Source Code** | 90 Python files (19k total LOC) |
