...
class TestPlayerPortraitUploadWorkflow:
    ...
    def test_upload_player_portrait_success(self, isolated_client, auth_headers, test_player, test_db_file_session):
        ...
        portrait_path = (
            Path(ImageProcessingService.get_image_directory(test_player.id, ImageType.PLAYER_PORTRAIT)) / "portrait.jpg"
        )
    ...
    def test_upload_player_portrait_replaces_existing(self, isolated_client, auth_headers, test_player):
        ...
        second_path = (
            Path(ImageProcessingService.get_image_directory(test_player.id, ImageType.PLAYER_PORTRAIT)) / "portrait.png"
        )
    ...
    def test_legacy_upload_endpoint_compatibility(
        self, isolated_client, auth_headers, test_player, test_db_file_session
    ):
