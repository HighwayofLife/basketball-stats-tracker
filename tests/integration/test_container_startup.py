...
class TestContainerStartup:
    ...
    def test_startup_with_database_connection_failure(self):
        ...
        bad_db_env = {
            "DATABASE_URL": "postgresql://baduser:badpass@nonexistent:5432/baddb"
        }
    ...
    def test_no_database_migrations_during_startup(self):
        ...
        with patch('app.services.database_admin_service.DatabaseAdminService.initialize_schema', 
                  side_effect=capture_migration_log):
            with patch('app.services.database_admin_service.DatabaseAdminService.upgrade_to_head',
                      side_effect=capture_migration_log):
    ...
    def test_middleware_configuration_in_production(self):
        ...
        with patch.dict(os.environ, prod_env):
            try:
                ...
                assert "TrustedHostMiddleware" in middleware_types, "TrustedHostMiddleware should be enabled in production"
    ...
    def test_docker_build_succeeds(self):
        ...
        try:
            ...
            result = subprocess.run([
                ...
                "--build-arg", "GIT_HASH=test123",
                "-t", "basketball-stats-test",
                "."
